    ...
    <Prose>
      ...
      <p>
        <ol>
          ...
          <li>
            <strong>Test volume and speakers:</strong> You have to make sure
            that you can hear the intervals clearly at a comfortable volume.
            Please use headphones or monitoring speakers. Laptop or phone
          ...
          <li>
            ...
            you need to get accustomed with how they sound. To do it you will
            have to listen to all 14 intervals in the random order without the
            need to rate them. That will give you an idea which intervals may
            sound like 7 or 1.
          </li>
          <li>
            <strong>Rating intervals:</strong> Finnaly you will be presented
            with a set of intervals that you will have to listen and rate. There
            only will be the same 14 intervals that you have listened to in the
