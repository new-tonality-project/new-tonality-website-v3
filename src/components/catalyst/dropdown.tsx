...
export function DropdownHeader({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
  return <div {...props} className={twMerge(className, 'col-span-5 px-3.5 pt-2.5 pb-1 sm:px-3')} />
}
...
export function DropdownLabel({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
  return <div {...props} data-slot="label" className={twMerge(className, 'col-start-2 row-start-1')} {...props} />
}
...
export function DropdownShortcut({
  ...
  return (
    <Headless.Description
      as="kbd"
      {...props}
      className={twMerge(className, 'col-start-5 row-start-1 flex justify-self-end')}
    >
